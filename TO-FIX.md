...
These production bugs were discovered during test development for PR #2 (testing foundation). AI cannot edit production code per Constitution P1 — a human developer must apply these fixes.
